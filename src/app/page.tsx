...
import { ChevronRight, Gift, ShoppingCart, Smartphone, Star, Zap } from "lucide-react";
...
const MotionWrapper = ({children, delay}: MotionWrapperProps)=>{
  return <motion.div initial={{opacity:0, y:50}} animate={{opacity: 1, y:0}} transition={{duration: 0.5,delay}}>
    {children}
  </motion.div>
...
export default function Home() {
  ...
  return <div className="min-h-screen">
    <div className="container mx-auto px-4 py-6 flex justift-between item-center">
      <h1 className="text-2xl font-bold">Gadget App</h1>
    </div>
    <main className="container mx-auto px-4 py-4">
        <section className="mb-24">
          <div className="flex flex-col justify-between md:flex-row items-center">
            ...
            <div className="w-1/3">
              <motion.div className="relative" style={{perspective: 1000}} animate={{
              ...
              >
                <Image className="rounded-3xl object-cover shadow-2xl mx-auto h-[500px] w-[250px]" width={1331} height={888} src={'/app-pics.png'} alt='Gadget'/>
                <Badge className="absolute top-4 left-4 bg-[#1bc464] text-white">New Release</Badge>
              </motion.div>
            </div>
          </div>
        </section>
